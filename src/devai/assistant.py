...
class CodeAssistant:
    ...
    def code_smell(self, code: str, context: str = "") -> str:
        """Identify code smells and suggest refactorings."""
        return self._run_chain(CODE_SMELL, code=code, context=context)

    def openapi(self, code: str, requirements: str = "") -> str:
        """Review or generate an OpenAPI specification."""
        return self._run_chain(OPENAPI, code=code, requirements=requirements)
