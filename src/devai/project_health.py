    ...
    def _build_recommendations(self, categories: list[HealthCategory]) -> list[str]:
        ...
        for cat in categories:
            if cat.name == "typing" and cat.score < 80:
                ...
                recs.append(
                    "Harden justfiles — avoid exporting secrets, disable dotenv-load or gitignore .env, use HTTPS imports, avoid curl|sh in recipes, and disable privileged Docker"
                )
