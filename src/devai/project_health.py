    ...
    def _build_recommendations(self, categories: list[HealthCategory]) -> list[str]:
        ...
        for cat in categories:
            if cat.name == "typing" and cat.score < 80:
                ...
                recs.append(
                    "Harden Vitest — keep server.fs.strict enabled, avoid remote setupFiles URLs, store secrets in env vars, bind browser/server hosts to localhost, and review test env blocks for credential leakage"
                )
