    ...
    def _build_recommendations(self, categories: list[HealthCategory]) -> list[str]:
        ...
        for cat in categories:
            if cat.name == "typing" and cat.score < 80:
                ...
                recs.append(
                    "Harden Maven — use HTTPS repositories, pin dependency versions, encrypt server credentials in settings.xml, avoid curl-pipe-to-shell in exec-maven-plugin, and never hardcode secrets in pom.xml"
                )
