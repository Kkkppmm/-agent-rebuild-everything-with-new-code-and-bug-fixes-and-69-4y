    ...
    def _build_recommendations(self, categories: list[HealthCategory]) -> list[str]:
        ...
        for cat in categories:
            if cat.name == "typing" and cat.score < 80:
                ...
                recs.append(
                    "Harden Vagrant — use SSH keys instead of passwords, bind forwarded ports to 127.0.0.1, disable SSH agent forwarding, and avoid curl-pipe-to-shell provisioners"
                )
