...
from devai.eleventy_analyzer import EleventyAnalyzer
...
class DevAI:
    ...
    def eleventy(self, path: str | Path = ".", **kwargs: Any) -> EleventyAnalyzer:
        """Audit .eleventy.js for disabled autoescape, remote passthrough copies, and exposed dev servers."""
        return EleventyAnalyzer(str(path), **kwargs)

    def docsify(self, path: str | Path = ".", **kwargs: Any) -> DocsifyAnalyzer:
        """Audit index.html for hardcoded auth headers, remote CDN scripts, and unsafe Docsify plugins."""
