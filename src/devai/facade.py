...
class DevAI:
    ...
    def taskfile(self, path: str | Path = ".", **kwargs: Any) -> TaskfileAnalyzer:
        """Audit Taskfile.yml/yaml for secrets, curl|sh patterns, and dangerous task commands."""
        return TaskfileAnalyzer(str(path), **kwargs)

    def justfile(self, path: str | Path = ".", **kwargs: Any) -> JustfileAnalyzer:
        """Audit justfile/Justfile for secrets, dotenv-load risks, and dangerous recipes."""
