...
class DevAI:
    ...
    def gitbook(self, path: str | Path = ".", **kwargs: Any) -> GitBookAnalyzer:
        """Audit .gitbook.yaml and book.json for secrets, remote plugins, and tracking scripts."""
        return GitBookAnalyzer(str(path), **kwargs)

    def readthedocs(self, path: str | Path = ".", **kwargs: Any) -> ReadTheDocsAnalyzer:
        """Audit .readthedocs.yaml for arbitrary build commands, insecure pip installs, and secrets."""
