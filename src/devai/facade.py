...
class DevAI:
    ...
    def gitbook(self, path: str | Path = ".", **kwargs: Any) -> GitBookAnalyzer:
        """Audit .gitbook.yaml and book.json for hardcoded secrets, insecure URLs, and unpinned plugins."""
        return GitBookAnalyzer(str(path), **kwargs)

    def readthedocs(self, path: str | Path = ".", **kwargs: Any) -> ReadTheDocsAnalyzer:
        """Audit .readthedocs.yaml for curl-pipe-to-shell, unpinned tools, and hardcoded build secrets."""
