...
class DevAI:
    ...
    def qwik(self, path: str | Path = ".", **kwargs: Any) -> QwikAnalyzer:
        """Audit Qwik City vite/qwik configs for exposed servers, define/env secret leaks, and CSRF bypass."""
        return QwikAnalyzer(str(path), **kwargs)

    def gatsby(self, path: str | Path = ".", **kwargs: Any) -> GatsbyAnalyzer:
        """Audit gatsby-config.* for siteMetadata secret leaks, internal proxies, and GraphQL playground exposure."""
