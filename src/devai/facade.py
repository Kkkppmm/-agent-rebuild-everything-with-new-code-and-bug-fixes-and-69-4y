...
class DevAI:
    ...
    def flask(self, path: str | Path = ".", **kwargs: Any) -> FlaskAnalyzer:
        """Audit Flask apps for debug mode, hardcoded secrets, CORS, SSTI, and SSRF risks."""
        return FlaskAnalyzer(str(path), **kwargs)

    def fastapi(self, path: str | Path = ".", **kwargs: Any) -> FastAPIAnalyzer:
        """Audit FastAPI apps for open CORS, exposed docs, secrets, and SSRF risks."""
    ...
    def django(self, path: str | Path = ".", **kwargs: Any) -> DjangoAnalyzer:
        """Audit Django settings for DEBUG, ALLOWED_HOSTS, CSRF, mark_safe, and SSRF risks."""
