...
class DevAI:
    ...
    def gitbook(self, path: str | Path = ".", **kwargs: Any) -> GitBookAnalyzer:
        """Audit .gitbook.yaml and book.json for secrets, insecure URLs, and external redirects."""
        return GitBookAnalyzer(str(path), **kwargs)

    def readthedocs(self, path: str | Path = ".", **kwargs: Any) -> ReadTheDocsAnalyzer:
        """Audit .readthedocs.yaml for secrets, curl|bash pipelines, and insecure git installs."""
