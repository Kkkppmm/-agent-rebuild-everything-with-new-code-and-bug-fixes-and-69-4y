...
class DevAI:
    ...
    def tflint(self, path: str | Path = ".", **kwargs: Any) -> TflintAnalyzer:
        """Audit TFLint configs for disabled security rules, unversioned plugins, and force=false."""
        return TflintAnalyzer(str(path), **kwargs)

    def hadolint(self, path: str | Path = ".", **kwargs: Any) -> HadolintAnalyzer:
        """Audit Hadolint configs for ignored security rules, wildcard trusted registries, and permissive thresholds."""
