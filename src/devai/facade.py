...
class DevAI:
    ...
    def circleci(self, path: str | Path = ".", **kwargs: Any) -> CircleCIAnalyzer:
        """Audit CircleCI configs for unpinned orbs and unsafe docker settings."""
    ...
    def jenkins(self, path: str | Path = ".", **kwargs: Any) -> JenkinsfileAnalyzer:
        """Audit Jenkinsfiles for hardcoded secrets and unsafe shell steps."""
    ...
    def bitbucket_pipelines(self, path: str | Path = ".", **kwargs: Any) -> BitbucketPipelinesAnalyzer:
        """Audit Bitbucket Pipelines configs for security and best practices."""
