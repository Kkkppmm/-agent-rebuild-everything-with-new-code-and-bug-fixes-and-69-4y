...
class DevAI:
    ...
    def hadolint(self, path: str | Path = ".", **kwargs: Any) -> HadolintAnalyzer:
        """Audit Hadolint configs for ignored security rules, permissive failure thresholds, and wildcard trusted registries."""
        return HadolintAnalyzer(str(path), **kwargs)

    def nuxt(self, path: str | Path = ".", **kwargs: Any) -> NuxtAnalyzer:
        """Audit Nuxt configs for hardcoded secrets, devtools in production, permissive CORS, and disabled SSR/CSRF."""
