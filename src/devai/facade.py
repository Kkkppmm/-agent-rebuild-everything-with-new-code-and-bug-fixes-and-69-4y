...
class DevAI:
    ...
    def commitizen(self, path: str | Path = ".", **kwargs: Any) -> CommitizenAnalyzer:
        """Audit Commitizen configs for bump-hook security and hardcoded secrets."""
        return CommitizenAnalyzer(str(path), **kwargs)

    def taskipy(self, path: str | Path = ".", **kwargs: Any) -> TaskipyAnalyzer:
        """Audit tasks.py for Invoke/taskipy security risks and dangerous shell usage."""
        return TaskipyAnalyzer(str(path), **kwargs)

    def towncrier(self, path: str | Path = ".", **kwargs: Any) -> TowncrierAnalyzer:
        """Audit Towncrier changelog configs for path traversal and unsafe templates."""
