...
class DevAIConfig:
    ...
    def from_env(cls, **overrides: Any) -> DevAIConfig:
        ...
        Reads ``DEVAI_API_KEY``, ``DEVAI_BASE_URL``, ``DEVAI_MODEL``,
        ``DEVAI_PROVIDER``, ``DEVAI_MAX_TOKENS``, and ``DEVAI_TEMPERATURE``.
        ...
        api_key = overrides.pop("api_key", None) or os.environ.get("DEVAI_API_KEY")
        model = overrides.pop("model", None) or os.environ.get("DEVAI_MODEL")
        base_url = overrides.pop("base_url", None) or os.environ.get("DEVAI_BASE_URL")
        max_tokens = overrides.pop("max_tokens", None)
        if max_tokens is None and os.environ.get("DEVAI_MAX_TOKENS"):
            max_tokens = int(os.environ["DEVAI_MAX_TOKENS"])
        temperature = overrides.pop("temperature", None)
        if temperature is None and os.environ.get("DEVAI_TEMPERATURE"):
            temperature = float(os.environ["DEVAI_TEMPERATURE"])
