...
def build_parser() -> argparse.ArgumentParser:
    ...
    p = sub.add_parser(
        "starlette-audit",
        help="Audit Starlette apps for hardcoded session secrets, open CORS, unsafe StaticFiles, and SSRF risks",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("-v", "--verbose", action="store_true", help="Print each finding")
    p.add_argument("--context", action="store_true", help="Print LLM context summary")
    ...
    p = sub.add_parser(
        "litestar-audit",
        help="Audit Litestar apps for hardcoded secrets, disabled CSRF, open CORS, exposed OpenAPI docs, and SSRF risks",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("-v", "--verbose", action="store_true", help="Print each finding")
    p.add_argument("--context", action="store_true", help="Print LLM context summary")
