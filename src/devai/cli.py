...
def cmd_travis_audit(args: argparse.Namespace) -> None:
...
def cmd_azure_audit(args: argparse.Namespace) -> None:
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p = sub.add_parser(
        "jenkinsfile-audit",
        help="Audit Jenkins pipelines for security and CI best practices",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
    ...
    p = sub.add_parser(
        "azure-audit",
        help="Audit Azure Pipelines configs for security and CI best practices",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
    p.add_argument(
        "--generate-template",
        action="store_true",
        help="Print a hardened Azure Pipelines configuration template",
    )
    p.set_defaults(func=cmd_azure_audit)
