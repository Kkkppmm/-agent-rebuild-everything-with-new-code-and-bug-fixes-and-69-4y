...
def build_parser() -> argparse.ArgumentParser:
    ...
    p = sub.add_parser(
        "hadolint-audit",
        help="Audit Hadolint configs for ignored security rules, permissive failure thresholds, and wildcard trusted registries",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
    ...
    p = sub.add_parser(
        "nuxt-audit",
        help="Audit Nuxt configs for hardcoded secrets, devtools in production, permissive CORS, and disabled SSR/CSRF",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
    p.add_argument(
        "--generate-template",
        action="store_true",
        help="Print a hardened nuxt.config template",
    )
