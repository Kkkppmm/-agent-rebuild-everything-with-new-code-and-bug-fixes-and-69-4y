...
def build_parser() -> argparse.ArgumentParser:
    ...
    p = sub.add_parser(
        "commitizen-audit",
        help="Audit Commitizen configs for bump-hook security and hardcoded secrets",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
    p.add_argument(
        "--generate-template",
        action="store_true",
        help="Print a hardened Commitizen configuration template",
    )
    p.set_defaults(func=cmd_commitizen_audit)

    p = sub.add_parser(
        "taskipy-audit",
        help="Audit tasks.py for Invoke/taskipy security risks",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
    ...
    p = sub.add_parser(
        "towncrier-audit",
        help="Audit Towncrier changelog configs for path traversal and unsafe templates",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
    p.add_argument(
        "--generate-template",
        action="store_true",
        help="Print a hardened Towncrier configuration template",
    )
