...
def build_parser() -> argparse.ArgumentParser:
    ...
    p = sub.add_parser(
        "hugo-audit",
        help="Audit Hugo configs for exposed servers, unsafe Goldmark, and remote scripts",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
    ...
    p = sub.add_parser(
        "vitepress-audit",
        help="Audit VitePress configs for exposed servers, fs.allow, and remote head scripts",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
    ...
    p = sub.add_parser(
        "docusaurus-audit",
        help="Audit Docusaurus configs for ignored broken links, remote scripts, and secrets",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
