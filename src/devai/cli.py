...
def build_parser() -> argparse.ArgumentParser:
    ...
    p = sub.add_parser(
        "tflint-audit",
        help="Audit TFLint configs for disabled security rules, unversioned plugins, and force=false",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
    ...
    p = sub.add_parser(
        "hadolint-audit",
        help="Audit Hadolint configs for ignored security rules, wildcard trusted registries, and permissive thresholds",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
