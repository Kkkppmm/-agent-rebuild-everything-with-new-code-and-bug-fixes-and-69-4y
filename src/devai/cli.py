...
def build_parser() -> argparse.ArgumentParser:
    ...
    p = sub.add_parser(
        "aiohttp-audit",
        help="Audit aiohttp apps for hardcoded secrets, open CORS, unsafe StaticRoute, and SSRF risks",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("-v", "--verbose", action="store_true", help="Print each finding")
    p.add_argument("--context", action="store_true", help="Print LLM context summary")
    ...
    p = sub.add_parser(
        "litestar-audit",
        help="Audit Litestar apps for hardcoded secrets, open CORS, disabled CSRF, and SSRF risks",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("-v", "--verbose", action="store_true", help="Print each finding")
    p.add_argument("--context", action="store_true", help="Print LLM context summary")
