...
def build_parser() -> argparse.ArgumentParser:
    ...
    p = sub.add_parser(
        "bottle-audit",
        help="Audit Bottle apps for hardcoded secrets, debug mode, path traversal, shell commands, and SSRF risks",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("-v", "--verbose", action="store_true", help="Print each finding")
    p.add_argument("--context", action="store_true", help="Print LLM context summary")
    p.add_argument(
        "--generate-template",
        action="store_true",
        help="Print a hardened Bottle app.py entry template",
    )
