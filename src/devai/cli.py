...
def build_parser() -> argparse.ArgumentParser:
    ...
    p = sub.add_parser("workflow-audit", help="Audit GitHub Actions workflows for CI security")
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
    p.add_argument(
    ...
    p = sub.add_parser("compose-audit", help="Audit Docker Compose files for container security")
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
    p.add_argument(
    ...
    p = sub.add_parser("precommit-audit", help="Audit pre-commit config for unpinned hooks")
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
    p.add_argument(
    ...
    p = sub.add_parser("kubernetes-audit", help="Audit Kubernetes manifests for pod security")
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
    p.add_argument(
