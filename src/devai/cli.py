...
def build_parser() -> argparse.ArgumentParser:
    ...
    p = sub.add_parser(
        "remix-audit",
        help="Audit remix.config.* for exposed dev servers, permissive watchPaths, and SSRF proxies",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
    ...
    p = sub.add_parser(
        "sveltekit-audit",
        help="Audit svelte.config.* for disabled CSRF checks, permissive CSP, and adapter leaks",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
    ...
    p = sub.add_parser(
        "gatsby-audit",
        help="Audit gatsby-config.* for siteMetadata secrets, GraphQL playground, and internal proxies",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
    ...
    p = sub.add_parser(
        "qwik-audit",
        help="Audit Qwik City vite/qwik configs for exposed dev/preview servers and SSRF proxies",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
