...
def build_parser() -> argparse.ArgumentParser:
    ...
    p = sub.add_parser(
        "isort-audit",
        help="Audit isort configs for honor_noqa=false, skip patterns, and Black profile conflicts",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
    ...
    p = sub.add_parser(
        "pylint-audit",
        help="Audit pylint configs for init-hook, disable=all, unsafe-load-any-extension, and broad ignore patterns",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
