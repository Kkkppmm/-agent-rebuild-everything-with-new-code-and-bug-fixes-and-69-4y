...
def build_parser() -> argparse.ArgumentParser:
    ...
    p = sub.add_parser(
        "vite-audit",
        help="Audit vite.config.* for permissive server settings, secrets, and sourcemap leaks",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
    p.add_argument(
        "--generate-template",
        action="store_true",
        help="Print a hardened Vite configuration template",
    )
    p.set_defaults(func=cmd_vite_audit)

    p = sub.add_parser(
        "tsconfig-audit",
        help="Audit tsconfig.json for disabled strict checks and unsafe path mappings",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
    p.add_argument(
        "--generate-template",
        action="store_true",
        help="Print a hardened TypeScript configuration template",
    )
    p.set_defaults(func=cmd_tsconfig_audit)

    p = sub.add_parser(
        "markdownlint-audit",
        help="Audit .markdownlint.* configs for disabled HTML rules and broad ignore globs",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
