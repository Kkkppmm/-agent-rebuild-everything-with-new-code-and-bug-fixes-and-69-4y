...
def _cmd_infra_audit(analyzer: Any, args: argparse.Namespace) -> None:
    if args.context:
        print(analyzer.to_context())
        return
    print(analyzer.summary())
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p = sub.add_parser("makefile-audit", help="Audit Makefiles for security and build risks")
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
    ...
    p = sub.add_parser(
        "terraform-audit",
        help="Audit Terraform files for security and infrastructure best practices",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
    ...
    p = sub.add_parser("nginx-audit", help="Audit Nginx configs for TLS and security header issues")
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
