...
def build_parser() -> argparse.ArgumentParser:
    ...
    p = sub.add_parser(
        "streamlit-audit",
        help="Audit Streamlit apps for secrets, unsafe HTML, XSRF, and SSRF risks",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("-v", "--verbose", action="store_true", help="Print each finding")
    p.add_argument("--context", action="store_true", help="Print LLM context summary")
    ...
    p = sub.add_parser(
        "gradio-audit",
        help="Audit Gradio apps for secrets, share links, auth, and SSRF risks",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("-v", "--verbose", action="store_true", help="Print each finding")
    p.add_argument("--context", action="store_true", help="Print LLM context summary")
    ...
    p = sub.add_parser(
        "chainlit-audit",
        help="Audit Chainlit apps for secrets, missing auth, CORS, and SSRF risks",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("-v", "--verbose", action="store_true", help="Print each finding")
    p.add_argument("--context", action="store_true", help="Print LLM context summary")
