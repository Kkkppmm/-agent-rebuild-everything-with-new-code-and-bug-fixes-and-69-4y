...
def build_parser() -> argparse.ArgumentParser:
    ...
    p = sub.add_parser(
        "qwik-audit",
        help="Audit Qwik City vite/qwik configs for exposed servers, define/env leaks, and CSRF bypass",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
    ...
    p = sub.add_parser(
        "gatsby-audit",
        help="Audit gatsby-config.* for siteMetadata secret leaks, internal proxies, and GraphQL playground",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
