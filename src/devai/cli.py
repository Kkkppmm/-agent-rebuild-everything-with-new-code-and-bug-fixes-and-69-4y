...
def build_parser() -> argparse.ArgumentParser:
    ...
    p = sub.add_parser(
        "ty-audit",
        help="Audit Astral ty configs for ignored rules and insecure paths",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
    ...
    p = sub.add_parser(
        "pep723-audit",
        help="Audit PEP 723 inline script metadata for dependency hygiene",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
    p.add_argument(
        "--generate-template",
        action="store_true",
        help="Print a hardened PEP 723 script metadata template",
    )
