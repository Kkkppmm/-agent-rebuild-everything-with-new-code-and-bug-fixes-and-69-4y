...
def build_parser() -> argparse.ArgumentParser:
    ...
    p = sub.add_parser(
        "pylint-audit",
        help="Audit .pylintrc and pyproject.toml [tool.pylint] for init-hook, disable=all, and unsafe extensions",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
    ...
    p = sub.add_parser(
        "isort-audit",
        help="Audit .isort.cfg and pyproject.toml [tool.isort] for honor_noqa=false and Black profile conflicts",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
    ...
    p = sub.add_parser(
        "pyright-audit",
        help="Audit pyrightconfig.json and pyproject.toml [tool.pyright] for relaxed type checking and insecure paths",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
