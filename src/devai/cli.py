...
def build_parser() -> argparse.ArgumentParser:
    ...
    p = sub.add_parser(
        "sveltekit-audit",
        help="Audit svelte.config.* for disabled CSRF checks, CSP bypass, adapter secrets, and SSRF proxies",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
    ...
    p = sub.add_parser(
        "remix-audit",
        help="Audit remix.config.* for path traversal, hardcoded secrets, exposed dev servers, and SSRF proxies",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
    ...
    p = sub.add_parser(
        "qwik-audit",
        help="Audit qwik.config.* for disabled CSRF/origin checks, adapter credential leaks, exposed dev servers, and SSRF proxies",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
    p.add_argument(
        "--generate-template",
        action="store_true",
        help="Print a hardened qwik.config.ts template",
    )
