...
def build_parser() -> argparse.ArgumentParser:
    ...
    p = sub.add_parser(
        "sveltekit-audit",
        help="Audit svelte.config.* for disabled CSRF, exposed dev servers, and adapter secrets",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="Print each finding")
    p.add_argument(
        "--generate-template",
        action="store_true",
    ...
    p = sub.add_parser(
        "gatsby-audit",
        help="Audit gatsby-config.* for siteMetadata secrets, internal proxies, and plugin secrets",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="Print each finding")
    ...
    p = sub.add_parser(
        "qwik-audit",
        help="Audit qwik.config.* and vite.config.* for exposed servers and disabled origin checks",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="Print each finding")
