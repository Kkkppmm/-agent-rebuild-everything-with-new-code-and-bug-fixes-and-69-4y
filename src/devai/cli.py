...
def build_parser() -> argparse.ArgumentParser:
    ...
    p = sub.add_parser(
        "circleci-audit",
        help="Audit CircleCI config for unpinned orbs and unsafe docker settings",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
    ...
    p.add_argument(
        "--generate-template",
        action="store_true",
        help="Print a hardened GitLab CI template",
    )
    p.set_defaults(func=cmd_gitlab_ci_audit)

    p = sub.add_parser(
        "jenkins-audit",
        help="Audit Jenkinsfiles for hardcoded secrets and unsafe shell steps",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
    ...
    p = sub.add_parser(
        ...
        help="Audit Bitbucket Pipelines for security and best practices",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
    ...
    p = sub.add_parser(
        "kubernetes-audit",
        help="Audit Kubernetes manifests for privileged containers and insecure settings",
    )
    p.add_argument("directory", nargs="?", default=".", help="Project directory")
    p.add_argument("--context", action="store_true", help="Output LLM-ready context")
    p.add_argument("--verbose", "-v", action="store_true", help="List all findings")
