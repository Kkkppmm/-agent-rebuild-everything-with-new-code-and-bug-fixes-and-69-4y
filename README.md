...
- **SecurityScanner** — Unified static security scan with 13 checks: secrets, injections, dangerous calls, insecure random, weak crypto, log injection, SSRF, path traversal, ReDoS, JWT security, unsafe deserialization, and insecure TLS
