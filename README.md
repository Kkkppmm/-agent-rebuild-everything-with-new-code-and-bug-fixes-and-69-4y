...
- **ComposeAnalyzer** — Audit Docker Compose files for privileged containers, host networking, and secrets in environment
- **WorkflowAnalyzer** — Audit GitHub Actions workflows for unpinned actions, broad permissions, and CI security risks
- **PrecommitAnalyzer** — Audit pre-commit config for unpinned hook revs and insecure repo URLs
- **MakefileAnalyzer** — Audit Makefiles for dangerous commands, sudo usage, and missing .PHONY declarations
