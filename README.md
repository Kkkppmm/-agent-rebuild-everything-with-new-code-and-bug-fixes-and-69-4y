...
- **K8sAnalyzer** — Audit Kubernetes manifests for privileged pods, host namespaces, secrets in env literals, dangerous hostPath mounts, and missing resource limits
