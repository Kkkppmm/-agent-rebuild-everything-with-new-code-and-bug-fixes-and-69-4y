...
- **AWSCodePipelineAnalyzer** — Audit AWS CodePipeline JSON/YAML for hardcoded OAuth tokens, missing KMS encryption, overprivileged roles, and pipeline variable injection
