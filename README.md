...
- **VagrantAnalyzer** — Audit HashiCorp Vagrant configs for hardcoded AWS keys, plaintext SSH passwords, public networks, SSH agent forwarding, curl-pipe-to-shell provisioners, and insecure box URLs
