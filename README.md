...
- **SecurityScanner** — Unified static security scan combining 14 checks: secrets, injections, dangerous calls, insecure random, weak crypto, log injection, SSRF, path traversal, ReDoS, JWT, unsafe deserialization, insecure TLS, and open redirects
