...
- **CherryPyAnalyzer** — Audit CherryPy apps for hardcoded session secrets, disabled XSRF protection, dev mode/autoreload, open CORS, path traversal in static handlers, shell command execution, and SSRF risks
