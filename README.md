...
- **MavenAnalyzer** — Audit Maven pom.xml and settings.xml for hardcoded secrets, insecure HTTP repositories, LATEST/RELEASE versions, SNAPSHOT dependencies, distributionManagement over HTTP, curl-pipe-to-shell in exec-maven-plugin, and SSL verification bypass
