...
- **MakefileAnalyzer** — Audit Makefiles for curl-pipe-to-shell, destructive rm, sudo usage, secrets in variables, and missing `.PHONY`
- **KubernetesAnalyzer** — Audit K8s manifests for privileged mode, host namespaces, hostPath volumes, secrets in env, and missing resource limits
