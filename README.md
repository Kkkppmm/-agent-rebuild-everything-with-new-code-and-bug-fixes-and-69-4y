...
- **LefthookAnalyzer** — Audit lefthook.yml and lefthook.yaml for hardcoded secrets, remote extends, mutable remote git refs, curl|sh in hook commands, sudo and chmod 777, git push --force, eval usage, TLS verification bypass, and sensitive path references
