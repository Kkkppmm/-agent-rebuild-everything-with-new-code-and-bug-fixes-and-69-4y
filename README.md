...
- **StarletteAnalyzer** — Audit Starlette ASGI apps for hardcoded secrets, open CORS with credentials, insecure StaticFiles mounts, short SessionMiddleware secrets, disabled host validation, and SSRF risks
