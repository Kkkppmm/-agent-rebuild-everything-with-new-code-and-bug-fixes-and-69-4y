...
- **LitestarAnalyzer** — Audit Litestar apps for hardcoded secrets, open CORS with credentials, disabled CSRF, exposed OpenAPI docs, unsafe static file mounts, debug mode, and SSRF risks
