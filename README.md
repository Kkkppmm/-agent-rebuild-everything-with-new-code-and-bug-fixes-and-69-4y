...
- **HardcodedConfigAnalyzer** — Detect hardcoded URLs, IPs, database URLs, and `os.getenv` defaults
- **SecurityScanner** — Unified static security scan combining 12 checks (secrets, injections, crypto, SSRF, deserialization, redirects, config, and more)
