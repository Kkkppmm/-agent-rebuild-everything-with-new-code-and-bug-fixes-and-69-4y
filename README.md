...
- **InsecureTLSAnalyzer** — Detect disabled TLS verification (`verify=False`, unverified SSL contexts)
- **SecurityScanner** — Unified static security scan combining 16 checks (secrets, injections, crypto, SSRF, deserialization, redirects, XSS, CORS, cookies, mass assignment, insecure TLS, and more)
