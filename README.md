...
- **TyAnalyzer** — Audit Astral ty type checker configs (ty.toml and pyproject.toml [tool.ty]) for rules.all=ignore, disabled import/assignment rules, broad allowed-unresolved-imports, replace-imports-with-any overrides, and hardcoded secrets
