...
- **XXEAnalyzer** — Detect XML External Entity vulnerabilities in stdlib and lxml XML parsing
- **SecurityScanner** — Unified static security scan combining secrets, injections, dangerous calls, insecure random, weak crypto, log injection, SSRF, XXE, and path traversal checks
