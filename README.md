...
- **MakefileAnalyzer** — Audit Makefiles for security risks (curl-pipe-to-shell, dangerous rm, secrets) and build best practices
- **KubernetesAnalyzer** — Audit Kubernetes manifests for privileged containers, host namespaces, :latest tags, secrets in env, and missing resource limits
