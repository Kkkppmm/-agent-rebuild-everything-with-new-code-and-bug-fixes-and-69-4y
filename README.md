...
- **Pipelines** — `DevPipeline` for composable review, debug, and test-generation workflows
...
for step in pipeline.full_review(code):
    print(step.step, step.response.content)
```
