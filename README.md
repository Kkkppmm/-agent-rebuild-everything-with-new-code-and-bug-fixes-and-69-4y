...
- **AiohttpAnalyzer** — Audit aiohttp apps for hardcoded secrets, open CORS with credentials, unsafe StaticRoute mounts, disabled TLS verification, hardcoded BasicAuth, debug mode, and SSRF risks
