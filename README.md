...
- **K8sManifestAnalyzer** — Audit Kubernetes YAML for privileged pods, host namespaces, dangerous hostPath mounts, secrets in env literals, and missing resource limits
