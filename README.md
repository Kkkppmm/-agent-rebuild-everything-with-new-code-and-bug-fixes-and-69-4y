...
- **SecurityScanner** — Unified static security scan combining secrets, injections, dangerous calls, insecure random, weak crypto, log injection, SSRF, unsafe deserialization, JWT security, insecure TLS, and path traversal checks
