...
- **DocstringCoverage** — Analyze docstring coverage across Python projects and export LLM context
- **DevTools** — Unified facade for imports, secrets, typing, docstrings, dependencies, and changelog
- **Project Scaffolding** — `scaffold_project()` and `DevAI.scaffold()` bootstrap new DevAI-powered projects
...
```python
from devai import DevTools, scaffold_project
...
result = scaffold_project("./my-app", package="myapp")
