...
- **Pep723Analyzer** — Audit PEP 723 inline script metadata blocks for missing dependencies, invalid TOML, unpinned packages, insecure source URLs, credentials in VCS URLs, and missing requires-python constraints
