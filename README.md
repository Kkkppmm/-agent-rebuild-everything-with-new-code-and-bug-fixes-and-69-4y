...
- **HadolintAnalyzer** — Audit `.hadolint.yaml` configs for ignored root-user/tag-pinning rules, permissive failure thresholds, broad trustedRegistries wildcards, and hardcoded secrets
