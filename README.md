...
- **JustfileAnalyzer** — Audit Justfile and justfile for hardcoded secrets in variable assignments, dotenv-load, sensitive paths, curl-pipe-to-shell in recipes, privileged Docker, disabled TLS verification, and SCM credentials in URLs
