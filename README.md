...
- **JenkinsfileAnalyzer** — Audit Jenkins pipelines for unpinned shared libraries, secrets in environment, privileged Docker agents, and unsafe shell steps
