...
- **CspellAnalyzer** — Audit `cspell.json` and `.cspell.yaml` configs for disabled spell-checking, broad ignore patterns on security docs, remote dictionary imports, and hardcoded secrets
