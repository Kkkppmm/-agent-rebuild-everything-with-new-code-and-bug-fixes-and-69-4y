...
- **JestAnalyzer** — Audit jest.config.* and package.json jest blocks for hardcoded secrets, eval in setup/transforms, insecure testURL, path traversal in moduleNameMapper, unpinned git presets, and remote testResultsProcessor URLs
