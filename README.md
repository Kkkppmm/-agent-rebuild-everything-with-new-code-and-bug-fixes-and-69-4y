...
- **LitestarAnalyzer** — Audit Litestar apps for hardcoded secrets, open CORS with credentials, disabled CSRF, exposed OpenAPI docs, insecure session cookies, debug mode, and SSRF risks
