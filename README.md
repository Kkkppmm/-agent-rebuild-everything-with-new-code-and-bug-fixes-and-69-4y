...
- **MkDocsAnalyzer** — Audit `mkdocs.yml` configs for exposed dev servers, arbitrary hooks, insecure URLs, disabled validation, broad snippet paths, and hardcoded secrets
