...
- **BottleAnalyzer** — Audit Bottle apps for hardcoded secrets, debug/reloader mode, SSTI via template(), path traversal in static_file(), shell command execution, and SSRF risks
