...
- **JustfileAnalyzer** — Audit Justfile, justfile, and *.just for hardcoded secrets in variable assignments, curl-pipe-to-shell in recipe bodies, privileged Docker, disabled TLS verification, sensitive paths, and SCM credentials in URLs
