...
- **LlamaIndexAnalyzer** — Audit LlamaIndex RAG pipelines for hardcoded API keys, SQL injection in NLSQL engines, SSRF in web readers, unsafe deserialization, exposed query engines, and prompt injection patterns
