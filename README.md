...
- **BunAnalyzer** — Audit bunfig.toml, bun.lock, and bun.lockb for hardcoded secrets, insecure registries, disabled TLS, trustedDependencies wildcards, and unpinned git deps
...
- **PlaywrightAnalyzer** — Audit playwright.config.* for ignoreHTTPSErrors, bypassCSP, --no-sandbox, remote debugging on 0.0.0.0, always-on trace/video/HAR recording, proxy credentials, and dangerous browser permissions
