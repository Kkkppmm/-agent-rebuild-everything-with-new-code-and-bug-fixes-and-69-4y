...
- **SecurityScanner** — Unified static security scan combining secrets, injections, dangerous calls, insecure random, weak crypto, log injection, SSRF, path traversal, and 50 security checks
...
- **InsecureBindAnalyzer** — Detect services bound to 0.0.0.0 or all network interfaces
- **MissingTimeoutAnalyzer** — Detect HTTP, socket, and subprocess calls without timeout parameters
