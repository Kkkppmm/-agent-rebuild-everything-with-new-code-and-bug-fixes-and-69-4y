...
- **LitestarAnalyzer** — Audit Litestar apps for hardcoded JWT/CSRF secrets, open CORS with credentials, disabled CSRF, exposed OpenAPI docs, debug mode, raw SQL, and SSRF risks
