...
- **WeakCryptoAnalyzer** — Detect weak cryptographic algorithms (MD5, SHA1, DES, RC4)
- **LogInjectionAnalyzer** — Detect dynamic log message construction from user-controlled input
- **CommandInjectionAnalyzer** — Detect dynamic shell command construction in os/subprocess calls
- **SecurityScanner** — Unified static security scan combining 8 security checks (secrets, injections, dangerous calls, weak crypto, and more)
