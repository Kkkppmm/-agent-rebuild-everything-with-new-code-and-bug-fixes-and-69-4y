...
- **MkDocsAnalyzer** — Audit `mkdocs.yml` / `mkdocs.yaml` for hardcoded secrets, insecure HTTP site/repo URLs, path traversal in docs_dir, exposed dev_addr, disabled strict mode, missing nav/site_url, and CDN scripts without integrity
