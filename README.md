...
- **XSSAnalyzer** — Detect reflected XSS in web handlers (unescaped user input in HTML output)
- **CSRFAnalyzer** — Detect missing CSRF protection on state-changing routes
